...
import com.sizebay.algorithm.restapi.model.{CalculateDeductionRequestObject, AnalysisRecommendationRequestObject, CalculateRecommendationRequestObject}
import com.sizebay.algorithm.restapi.validate.ValidateCommand
...
class SizeBayAPI(val system: ActorSystem, val restApiConfig: Config, val requestBalancerControllerActor: ActorSelection, val dataSource: DataSource) extends ScalatraServlet with Authentication {
